      ...
      <aside class="col-md-3 mb-4 shadow-sm h-100">
        <ul class="list-group">
          ...
          <a href="../Page4/personalinfo.php" class="text-decoration-none">
            <li class="list-group-item" style="color: white; background-color: #005f99;">Personal
              Information</li>
          </a>
        ...
        <ul class="nav nav-tabs mb-4">
          <li class="nav-item">
            <a class="nav-link active" style="background-color: #005f99; color: white;"
              href="personalInfo.php">Personal Info.</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="./passInfo.php" style="color: #005f99; ">Passport Info</a>
          </li>
          <li class="nav-item">
