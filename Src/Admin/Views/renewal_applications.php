...
<head>
    <title>Renewal Applications</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <aside class="sidebar">
        <div class="list-group list-group-flush">
            ...
            <a href="/application/renewal" class="list-group-item list-group-item-action active">
    ...
    <main class="main-content">
        <div class="container-fluid">
            <h1 class="mb-4"><i class="fas fa-sync-alt me-2"></i> Renewal Applications</h1>
            ...
            <div id="applicationListView">
                ...
                <div class="card application-card border-danger">
                    <div class="card-header bg-danger text-white">
                        <h2 class="mb-0"><i class="fas fa-exclamation-circle me-2"></i> Urgent Renewal Applications</h2>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($urgentRenewalApps)): ?>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php foreach ($urgentRenewalApps as $index => $app): ?>
                                            <tr>
                                                <td><?= $index + 1 ?></td>
                        ...
                        <?php else: ?>
                            <div class="alert alert-info">No urgent renewal applications found.</div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="card application-card border-info mt-4">
                    <div class="card-header bg-info text-white">
                        <h2 class="mb-0"><i class="fas fa-file-alt me-2"></i> Normal Renewal Applications</h2>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($normalRenewalApps)): ?>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php foreach ($normalRenewalApps as $index => $app): ?>
                                            <tr>
                                                <td><?= $index + 1 ?></td>
                        ...
                        <?php else: ?>
                            <div class="alert alert-info">No normal renewal applications found.</div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-view" id="applicationDetailView">
                ...
                <div class="card border-0 shadow-none">
                    <div class="card-header bg-white border-0">
                        <h2 class="mb-0 text-primary"><i class="fas fa-file-invoice me-2"></i> Renewal Application Details</h2>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="detail-section">
                            <h4 class="detail-section-title">Passport Information</h4>
                            <div class="passport-info mb-3">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="detail-item">
                                            <div class="detail-label">Old Passport Number</div>
                        ...
                        <div class="detail-section">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="detail-item">
                                        <div class="detail-label">Old Passport</div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.view-btn').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    document.getElementById('detail-service-type').textContent = appData.service_type || 'N/A';
                    ...
                    // Documents
                    const oldPassport = appData.old_passport_attachment;
                    const photo = appData.photo_attachment;
                    ...
                    if (oldPassport) {
                        document.getElementById('old-passport').src = '/public/uploads/' + oldPassport;
                    } else {
                        document.getElementById('old-passport-container').innerHTML = 'Not provided';
                    }

                    if (photo) {
                        document.getElementById('photo').src = '/public/uploads/' + photo;
                    } else {
