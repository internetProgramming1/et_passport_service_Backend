...
<head>
    <title>Lost Passport Applications</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <aside class="sidebar">
        <div class="list-group list-group-flush">
            <a href="/application/new" class="list-group-item list-group-item-action">
            ...
            <a href="/application/lost" class="list-group-item list-group-item-action active">
    ...
    <main class="main-content">
        <div class="container-fluid">
            <h1 class="mb-4"><i class="fas fa-exclamation-triangle me-2"></i> Lost Passport Applications</h1>
            <!-- Search Form -->
            <div class="row mb-4">
                <div class="col-md-6">
            ...
            <div id="applicationListView">
                ...
                <div class="card application-card border-danger">
                    <div class="card-header bg-danger text-white">
                        <h2 class="mb-0"><i class="fas fa-exclamation-circle me-2"></i> Urgent Lost Passport Applications</h2>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($urgentLostApps)): ?>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php foreach ($urgentLostApps as $index => $app): ?>
                                            <tr>
                                                <td><?= $index + 1 ?></td>
                                                <td><?= htmlspecialchars($app['first_name'] . " " . $app['middle_name'] . " " . $app['last_name']) ?></td>
                                                <td><?= htmlspecialchars($app['old_passport_number']) ?></td>
                                                <td><?= htmlspecialchars($app['email']) ?></td>
                                                <td><?= htmlspecialchars($app['phone']) ?></td>
                                                <td><?= date('M d, Y H:i', strtotime($app['created_at'])) ?></td>
                                                <td>
                        ...
                        <?php else: ?>
                            <div class="alert alert-info">No urgent lost passport applications found.</div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="card application-card border-info mt-4">
                    <div class="card-header bg-info text-white">
                        <h2 class="mb-0"><i class="fas fa-file-alt me-2"></i> Normal Lost Passport Applications</h2>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($normalLostApps)): ?>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php foreach ($normalLostApps as $index => $app): ?>
                                            <tr>
                                                <td><?= $index + 1 ?></td>
                        ...
                        <?php else: ?>
                            <div class="alert alert-info">No normal lost passport applications found.</div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-view" id="applicationDetailView">
                ...
                <div class="card border-0 shadow-none">
                    <div class="card-header bg-white border-0">
                        <h2 class="mb-0 text-primary"><i class="fas fa-file-invoice me-2"></i> Lost Passport Application Details</h2>
                    </div>
                    <div class="card-body">
                        ...
                        <!-- Lost Passport Information Section -->
                        <div class="detail-section">
                            <h4 class="detail-section-title">Lost Passport Information</h4>
                            <div class="lost-info mb-3">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="detail-item">
                                            <div class="detail-label">Lost Passport Number</div>
                                            <div class="detail-value" id="detail-passport-number"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-item">
                                            <div class="detail-label">Issue Date</div>
                                            <div class="detail-value" id="detail-issue-date"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="detail-item">
                                            <div class="detail-label">Expiry Date</div>
                                            <div class="detail-value" id="detail-expiry-date"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="detail-item">
                                            <div class="detail-label">Has Correction</div>
                                            <div class="detail-value" id="detail-has-correction"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="detail-item">
                                            <div class="detail-label">Correction Type</div>
                                            <div class="detail-value" id="detail-correction-type"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="detail-section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="detail-item">
                                        <div class="detail-label">Birth Certificate</div>
                                        <div class="detail-value" id="detail-birth-cert"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="detail-section">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="detail-item">
                                        <div class="detail-label">Old Passport Copy</div>
                                        <div id="old-passport-container">
                                            <img src="" class="document-thumbnail" id="old-passport" alt="Old Passport">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="detail-item">
                                        ...
                                        <div id="photo-container">
                                            <img src="" class="document-thumbnail" id="photo" alt="Photo">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="detail-item">
                                        <div class="detail-label">Police Assurance</div>
                                        <div id="police-assurance-container">
                                            <img src="" class="document-thumbnail" id="police-assurance" alt="Police Assurance">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.view-btn').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    document.getElementById('detail-passport-number').textContent = appData.old_passport_number || 'N/A';
                    document.getElementById('detail-issue-date').textContent = appData.old_issue_date || 'N/A';
                    document.getElementById('detail-expiry-date').textContent = appData.old_expiry_date || 'N/A';
                    document.getElementById('detail-has-correction').textContent = appData.has_correction ? 'Yes' : 'No';
                    document.getElementById('detail-correction-type').textContent = appData.correction_type || 'N/A';
                    ...
                    document.getElementById('detail-age-category').textContent = isUrgent ?
                        ...
                        (appData.under18 === '1' ? 'Under 18' : '18 or Above');
                    ...
                    document.getElementById('detail-birth-cert').textContent = isUrgent ?
                    ...
                    // Documents
                    const oldPassport = isUrgent ? appData.old_passport_attachment : appData.old_passport_attachment;
                    const photo = isUrgent ? appData.photo_attachment : appData.photo_attachment;
                    const policeAssurance = isUrgent ? appData.police_assurance_attachment : appData.police_assurance_attachment;
                    const idFront = isUrgent ? appData.id_front_attachment : appData.id_front_attachment;
                    const idBack = isUrgent ? appData.id_back_attachment : appData.id_back_attachment;

                    if (oldPassport) {
                        document.getElementById('old-passport').src = oldPassport;
                    } else {
                        document.getElementById('old-passport-container').innerHTML = 'Not provided';
                    }

                    if (photo) {
                        document.getElementById('photo').src = photo;
                    } else {
                        document.getElementById('photo-container').innerHTML = 'Not provided';
                    }

                    if (policeAssurance) {
                        document.getElementById('police-assurance').src = policeAssurance;
                    } else {
                        document.getElementById('police-assurance-container').innerHTML = 'Not provided';
                    }

                    if (idFront) {
                        document.getElementById('id-front').src = idFront;
                    } else {
                        document.getElementById('id-front-container').innerHTML = 'Not provided';
                    }

                    if (idBack) {
                        document.getElementById('id-back').src = idBack;
                    } else {
                        document.getElementById('id-back-container').innerHTML = 'Not provided';
                    }
