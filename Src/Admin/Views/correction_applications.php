...
<head>
    <title>Correction Applications</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <aside class="sidebar">
        <div class="list-group list-group-flush">
            ...
            <a href="/application/correction" class="list-group-item list-group-item-action active">
    ...
    <main class="main-content">
        ...
        <h1 class="mb-4"><i class="fas fa-edit me-2"></i> Correction Applications</h1>
        <!-- Search Form -->
        <div class="row mb-4">
            <div class="col-md-6">
        ...
        <div id="applicationListView">
            ...
            <div class="card application-card border-danger">
                <div class="card-header bg-danger text-white">
                    <h2 class="mb-0"><i class="fas fa-exclamation-circle me-2"></i> Urgent Correction Applications</h2>
                </div>
                <div class="card-body">
                    <?php if (!empty($urgentCorrectionApps)): ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                    ...
                    <?php else: ?>
                        <div class="alert alert-info">No urgent correction applications found.</div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="card application-card border-info mt-4">
                <div class="card-header bg-info text-white">
                    <h2 class="mb-0"><i class="fas fa-file-alt me-2"></i> Normal Correction Applications</h2>
                </div>
                <div class="card-body">
                    <?php if (!empty($normalCorrectionApps)): ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php foreach ($normalCorrectionApps as $index => $app): ?>
                                        <tr>
                                            <td><?= $index + 1 ?></td>
                    ...
                    <?php else: ?>
                        <div class="alert alert-info">No normal correction applications found.</div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="detail-view" id="applicationDetailView">
            ...
            <div class="card border-0 shadow-none">
                <div class="card-header bg-white border-0">
                    <h2 class="mb-0 text-primary"><i class="fas fa-file-invoice me-2"></i> Correction Application Details</h2>
                </div>
                <div class="card-body">
                    ...
                    <!-- Correction Information Section -->
                    <div class="detail-section">
                        <h4 class="detail-section-title">Correction Information</h4>
                        <div class="correction-info mb-3">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="detail-item">
